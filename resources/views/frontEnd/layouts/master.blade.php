...
<html lang="en">
    <head>
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-7463297479533478"
...
<style>
   body, h1, h2, h3, p, a, span, div, input, button {
...
.cs{
    ...
    <body class="gotop">
        ...
        <div class="mobile-menu">
                <div style="box-shadow: 0px 0px 3px 0px #383838;"class="mobile-menu-logo">
                    <div class="logo-image">
                        <img style="broder-radius:7px;"src="{{asset($generalsetting->white_logo)}}" alt="" />
                    </div>
            ...
            <div class="top_header" style="background-color:#007c71">
...
⭐ আরজামার্ট - আপনার নির্ভরযোগ্য অনলাইন শপ | নিরাপদ কেনাকাটা ✅ | মানসম্মত পণ্য 🎁 | দ্রুত ডেলিভারি 🚚 | নিশ্চিন্তে অর্ডার করুন আজই!
            ...
            <div style="" class="mobile-header sticky">
                <div class="mobile-logo">
                    ...
                    <div class="menu-logo">
                        ...
                        <a href="{{route('home')}}"><img style="width:140px;height:40px;" src="{{asset($generalsetting->white_logo)}}" alt="" /></a>
                    </div>
                    <div class="menu-bag">
            ...
            <div class="mobile-search">
                <form style="border:1px solid #000;background:#000;" action="{{route('search')}}">
                    <input type="text" placeholder="Search Product ... " value="" class="msearch_keyword msearch_click" name="keyword" />
                    <button style="background: #007c71;;"><i data-feather="search"></i></button>
                </form>
            ...
            <div style="" class="main-header">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="logo-header">
                                    <div class="main-logo">
                                        <a style="broder-radius:7px;"href="{{route('home')}}"><img src="{{asset($generalsetting->white_logo)}}" alt="" /></a>
                                    </div>
                                    <div class="main-search">
                                        <form style="border:1px solid #000;background:#000;" action="{{route('search')}}">
                                            <input type="text" placeholder="Search Product..." class="search_keyword search_click" name="keyword" />
                                            <button style="background: #007c71;;">
               ...
               <!-- <div  style="background:#ffffff;border:1px #fff solid;" class="menu-area">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="catagory_menu">
                                    <ul >
                                        @foreach ($menucategories as $scategory)
                                        <li class="cat_bar ">
                                            <a style="background:#a7c106;border:1px #fff solid;" href="{{ url('category/' . $scategory->slug) }}"> 
            ...
            <div class="row">
                <div class="col-sm-4 mb-3 mb-sm-0">
                    <div class="footer-about">
                        ...
                        <a href="tel:{{ $contact->hotline ?? '' }}" class="footer-hotline">
                            {{ $contact->hotline ?? 'Hotline not available' }}
                        </a>
                    </div>
                </div>
                <!-- col end -->
                        ...
                        <ul>
                            ...
                            @isset($pages)
                                @foreach($pages as $page)
                                    <li><a href="{{ route('page', ['slug' => $page->slug ?? '']) }}">{{ $page->name ?? 'Untitled Page' }}</a></li>
                                @endforeach
                            @endisset
                        </ul>
                    </div>
                        ...
                        <ul>
                            ...
                            @isset($pagesright)
                                @foreach($pagesright as $value)
                                    <li>
                                        <a href="{{ route('page', ['slug' => $value->slug ?? '']) }}">{{ $value->name ?? 'Untitled Page' }}</a>
                                    </li>
                                @endforeach
                            @endisset
                        </ul>
    ...
    <div style="background:#007c71;" class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="copyright">
                        <p>Copyright © {{ date('Y') }} {{ $generalsetting->name ?? 'Company Name' }}. All rights reserved| DEVELOPED💖 by <a href="https://www.facebook.com/FM032">Maruf</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>!function(){var e,t,n,a;window.MyAliceWebChat||((t=document.createElement("div")).id="myAliceWebChat",(n=document.createElement("script")).type="text/javascript",n.async=!0,n.src="https://widget.myalice.ai/index.js",(a=(e=document.body.getElementsByTagName("script"))[e.length-1]).parentNode.insertBefore(n,a),a.parentNode.insertBefore(t,a),n.addEventListener("load",(function(){MyAliceWebChat.init({selector:"myAliceWebChat",number:"8801951887919",message:"",color:"#25D366",channel:"wa",boxShadow:"low",text:"",theme:"light",position:"left",mb:"20px",mx:"20px",radius:"20px"})})))}();</script>
        <!-- Google Tag Manager (noscript) -->
        <script>
    document.addEventListener("DOMContentLoaded", function () {
        const cartIcon = document.querySelector(".menu-bag");

        // Check if it's mobile (width < 768px for example)
        if (window.innerWidth < 768) {
            cartIcon.addEventListener("click", function () {
                window.location.href = "/customer/checkout"; // আপনার checkout page এর link
            });
        }
    });
</script>
