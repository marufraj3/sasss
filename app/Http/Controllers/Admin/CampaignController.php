    ...
    public function store(Request $request)
{
    ...
    $input = $request->except(['files', 'image', 'image_one', 'image_two', 'image_three']);
    $uploadPath = 'public/uploads/campaign/';

    // Handle single images
    $singleImages = ['image_one', 'image_two', 'image_three'];
    foreach ($singleImages as $imgField) {
        ...
        if ($image) {
            ...
            // Resize logic (width or height defined)
            $width = $img->width();
            $height = $img->height();
            if ($img->height() > $img->width()) {
                $width = null; // height will be fixed
            } else {
                $height = null; // width will be fixed
            }
            ...
            $input[$imgField] = $imageUrl; // save path to DB
        }
    }
